...
export const clientsApi = {
  ...
  grantVisa: (id: string) =>
    api.post<Client>(`/clients/${id}/grant-visa`),

  uploadVisaPhoto: (id: string, photo: string) =>
    api.post(`/clients/${id}/visa-photo`, { photo }),

  deleteVisaPhoto: (id: string) =>
    api.delete(`/clients/${id}/visa-photo`),
